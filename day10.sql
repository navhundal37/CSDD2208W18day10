...
/*!50001 CREATE TABLE `d10_v1` (
  ...
  `MIN_SALARY` tinyint NOT NULL,
  `MAX_SALARY` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `d11_vi`
--

DROP TABLE IF EXISTS `d11_vi`;
/*!50001 DROP VIEW IF EXISTS `d11_vi`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `d11_vi` (
...
--
-- Temporary table structure for view `s11_vi`
--

DROP TABLE IF EXISTS `s11_vi`;
/*!50001 DROP VIEW IF EXISTS `s11_vi`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `s11_vi` (
  `id` tinyint NOT NULL,
...
INSERT INTO `students` VALUES (1,'ranjit','A',1241234343),(2,'gurvir','B',1241289743),(4,'navdeep','A',2147483647);
...
/*!50001 VIEW `d10_v1` AS select `jobs`.`JOB_ID` AS `JOB_ID`,`jobs`.`JOB_TITLE` AS `JOB_TITLE`,`jobs`.`MIN_SALARY` AS `MIN_SALARY`,`jobs`.`MAX_SALARY` AS `MAX_SALARY` from `jobs` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `d11_vi`
--

/*!50001 DROP TABLE IF EXISTS `d11_vi`*/;
/*!50001 DROP VIEW IF EXISTS `d11_vi`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `s11_vi` AS select `students`.`id` AS `id`,`students`.`name` AS `name`,`students`.`grade` AS `grade`,`students`.`phone` AS `phone` from `students` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-01-19 11:54:09
